...
const FAQS = [
  ...
  },
  {
    ...
    a: "MIUC Flagship Campus H-8, Islamabad. PreLaunch 5 Sept; The Colosseum 2–4 Oct, 2026.",
  },
];
  ...
  return (
    <>
      ...
      >
        ...
        >
          <span style={{ color: "var(--red-arena)", fontWeight: 700 }}>Sept 5 · Oct 2–4, 2026</span>
